...
export function findBestPricingMatch(input) {
  ...
  return {
    matchedProductCategory: extractMatchValue(best.row, FILTER_KEYS.productType),
    matchedMaterial: extractMatchValue(best.row, FILTER_KEYS.material),
    matchedThicknessDepth: `${extractMatchValue(best.row, FILTER_KEYS.thickness)} / ${extractMatchValue(best.row, FILTER_KEYS.returnDepth)}`,
    matchedSizeHeight: extractMatchValue(best.row, FILTER_KEYS.letterHeight),
