...
export default function DisplayTradeshowProductsPage() {
  ...
  const activeTiers = selectedSize?.tierPricingBySideAndHardware?.[selectedSided]?.[selectedHardware] || selectedSize?.tierPricingBySide?.[selectedSided] || selectedSize?.tierPricing || [];
